...
`Python` `Clojure` `AWS` `SQL` `Elasticsearch` `SQL` `Javascript` `React` `Elasticsearch` `Airflow` `DBT`
...
For logistics: I would strongly prefer a hybrid on-site/remote model in London -- ideally coming to the office between 2 and 3 days a week.

## <a name="synopsis">Me in a nutshell (spoilers ahead)</a>

Ultimately, I am a product-focused software engineer. I have never been obsessed with technology for technology's sake -- rather, I love to use software to solve actual problems. I learned this about myself when I worked for Intercom, where I was the first ever US-based hire. My role was "administrative" in title only -- in reality, my job was to free the founding team from having to think about anything that wasn't our product. From 6 to 350+ employees, I managed multiple operational departments, some of them single-handedly. Writing scripts to help me do my job effectively became essential to my productivity.

Eventually I made the choice to actually study software development in a serious way. I applied for one of the world's most selective coding bootcamps: Makers Academy in London. I was actually surprised by how much I enjoyed my studies - and I fell in love with London in the process. After graduating, I joined a small fintech company called Osper, where I was primarily scripting tools for internal use, but also developing the mobile app using Python & Flask.

Wanting more exposure to larger scale problems & systems, I left to join a fashion tech company called EDITED, which tracked clothing metadata for use by major international retailers to compare things like prices, styles, colours, silhouettes and buzzwords across other retailers. EDITED relied on thousands of website crawlers to gather and normalise this data. My major projects here were centered around monitoring and alerting on crawler health, schedules and data volumes. I built and maintained an internal service for this purpose, owning both the backend and the UI, which is still in use today.

My tenure at Signal AI, where I currently work, has spanned two teams - Data Ingestion and Concepts, the core AI team. On the data ingestion side, my team oversaw all provider integrations, bringing in and normalising between 5 - 8 million news articles per day, storing & deduplicating these articles, and designing / developing our data model for the metadata associated with this content. I later moved on to the Concepts team, where my team and I look after all of the machine learning models designed to extract and generate metadata from this news content. I work closely with data scientists to productionise new models and classifiers in a performant, scalable way.

## <a name="work">Experience</a>

**Signal AI** (Apr 2020 to Present)
